...
//返回：无
//==============================================================
void Display_3_0(int16 i,uint8 x,uint8 y)
{
      int8 a[4]={0}; 
      if(i<0)
      {
...
//返回：无
//==============================================================
void Display_3_1(uint8 i,uint8 x,uint8 y)
{
      int8 a[3]={0}; 
      if(i<0)
      {
...
//返回：无
//==============================================================
void Display_2_0(int16 i,uint8 x,uint8 y)
{
      int8 a[3]={0}; 
      if(i<0)
      {
...
//返回：无
//==============================================================
void Display_2_1(uint8 i,uint8 x,uint8 y)
{
      int8 a[2]={0}; 
      if(i<0)
      {
...
//返回：无
//==============================================================
void Display_f(float i,uint8 x,uint8 y)
{
      int8 a[3]={0};
      uint8 ai;
      if(i<0)
...
//返回：无
//==============================================================
void DisPlay(uint16 i,uint8 x,uint8 y)//两位正数显示
{
      int8 a[3]={0}; 
